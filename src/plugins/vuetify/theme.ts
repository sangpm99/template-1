...
export const staticPrimaryColor = ref<string>("#666cff");
export const staticPrimaryDarkenColor = ref<string>("#666cff");

export const themes: Record<string, ThemeDefinition> = {
  light: {
    dark: false,
    colors: {
      primary: staticPrimaryColor.value,
      "primary-light": "#74b9ff",
      "on-primary": "#fff",
      "primary-darken-1": staticPrimaryDarkenColor.value,
      secondary: "#6D788D",
